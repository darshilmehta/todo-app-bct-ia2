...
const Navbar: FC = () => {
    ...
    return <nav className={'text-white py-5 flex md:flex-row flex-col gap-5 justify-between items-center'}>
        ...
        <div className={'flex gap-10 items-center'}>
            <ThemeToggler />
            <a href={'https://github.com/darshilmehta/todo-app-bct-ia2'} className={'text-lg text-white hover:text-blue transition-all ease-out duration-300 dark:text-white text-gray-700'}>GitHub</a>
            {
                wallet ?
